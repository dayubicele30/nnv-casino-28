...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-cb6a95b9');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-cb6a95b9');}
...
var brandEl=document.querySelector('.rl-brand-cb6a95b9');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
